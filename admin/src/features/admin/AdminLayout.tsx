...
export const AdminLayout = () => {
  ...
  const menuItems = [
    ...
    { name: 'Content & CMS', path: '/content', icon: FileText, badge: 'Live' },
    { name: 'Formulations', path: '/products', icon: ShoppingBag, badge: '2' },
    { name: 'Media Library', path: '/media', icon: ImageIcon, badge: null },
    { name: 'Trade Inquiries', path: '/inquiries', icon: MailOpen, badge: 'Leads' },
    { name: 'Site & WhatsApp', path: '/settings', icon: Settings, badge: null }
  ];
    ...
    <div className="min-h-screen bg-[#F1EFE7] text-[#2D2D2D] flex font-body">
        ...
        <div className="p-4 space-y-6">
          ...
          <div className="flex items-center justify-between gap-2 px-2 py-1">
            ...
            <button
              ...
              className="p-1.5 rounded-lg text-[#57534E] hover:text-[#121110] hover:bg-[#F1EFE7] transition-colors"
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-x-hidden">
        ...
        <header className="sticky top-0 z-20 h-18 border-b px-4 sm:px-8 flex items-center justify-between gap-4 bg-white/95 border-[#D8D2C8] backdrop-blur-xl">
          ...
          {/* Right: Live Public Website External Link & Profile */}
          <div className="flex items-center gap-3">
            <a
              href={publicStoreUrl}
              target="_blank"
