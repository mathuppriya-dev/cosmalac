      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-white hover:bg-[#F1EFE7] border border-[#D8D2C8] rounded-2xl text-xs font-bold text-[#121110] transition-all duration-150 shadow-xs group"
          >
