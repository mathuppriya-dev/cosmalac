...
export const About = () => {
  return (
    <>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-20 font-body">
        {/* ================= 1. PREMIUM ABOUT HERO ================= */}
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div class="space-y-6 text-left">
            <span class="text-xs font-semibold uppercase tracking-widest text-rose-gold">Est. 2016</span>
            <h1 class="text-4xl sm:text-5xl font-extrabold text-text-primary font-heading leading-tight">
              Pioneering Scientific <br />
              <span class="text-rose-gold italic">Cosmetics</span>
            </h1>
          ...
          <div class="relative aspect-video rounded-3xl overflow-hidden border border-border-pink shadow bg-bg-secondary flex items-center justify-center">
            <img
        ...
        <section class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="bg-white border border-border-pink p-6 rounded-2xl space-y-4">
            <Target class="text-rose-gold" size={28} />
            <h3 class="text-lg font-bold text-text-primary font-heading">Our Mission</h3>
          ...
          <div class="bg-white border border-border-pink p-6 rounded-2xl space-y-4">
            <Compass class="text-rose-gold" size={28} />
            <h3 class="text-lg font-bold text-text-primary font-heading">Our Vision</h3>
            <p class="text-xs text-text-secondary leading-relaxed">
          ...
          <div class="bg-white border border-border-pink p-6 rounded-2xl space-y-4">
            <ShieldCheck class="text-rose-gold" size={28} />
            <h3 class="text-lg font-bold text-text-primary font-heading">Our Values</h3>
            <p class="text-xs text-text-secondary leading-relaxed">
        ...
        <section class="space-y-12">
          <div class="text-center space-y-3">
            <span class="text-xs font-semibold uppercase tracking-widest text-rose-gold">Milestones</span>
            <h2 class="text-3xl font-bold text-text-primary font-heading">Our Chronological Journey</h2>
          </div>

          <div class="relative max-w-3xl mx-auto border-l-2 border-border-pink/80 pl-8 space-y-12">
            {TIMELINE_MILESTONES.map((milestone, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                class="relative space-y-2 text-left"
              >
                {/* Glowing Node */}
                <div class="absolute -left-[41px] top-1.5 w-6 h-6 rounded-full border-4 border-white bg-rose-gold flex items-center justify-center shadow-sm">
                  <Calendar size={10} class="text-white" />
                </div>
                
                <span class="text-xs font-bold text-rose-gold font-body">{milestone.year}</span>
                <h3 class="text-lg font-bold text-text-primary font-heading">{milestone.title}</h3>
                <p class="text-xs text-text-secondary leading-relaxed font-body">{milestone.description}</p>
              </motion.div>
            ))}
          </div>
        </section>
        ...
        {/* ================= 4. FOUNDERS MESSAGE ================= */}
        <section class="bg-bg-secondary border border-border-pink rounded-3xl p-8 md:p-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div class="lg:col-span-8 space-y-4 text-left">
            <span class="text-xs font-semibold uppercase tracking-widest text-rose-gold font-body">Co-Founder's Commitment</span>
            <h2 class="text-2xl sm:text-3xl font-bold text-text-primary font-heading">"Skincare is a Science, Not a Shortcut"</h2>
            <p class="text-sm text-text-secondary italic leading-relaxed font-body">
            ...
            <h4 class="text-sm font-semibold text-text-primary font-body">— Anura Gunasekara, Co-Founder & Chief Chemist</h4>
          </div>
          <div class="lg:col-span-4 flex justify-center">
            <div class="w-32 h-32 rounded-full bg-brand-primary/20 border border-brand-primary/40 flex items-center justify-center">
              <Heart size={44} class="text-rose-gold animate-pulse" />
            </div>
          </div>
        </section>
      </div>
