  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 text-left font-body leading-relaxed space-y-6">
        <h1 className="text-3xl font-bold font-heading text-text-primary border-b border-border-pink pb-4">Terms of Service</h1>
        <p className="text-xs text-text-secondary">Effective Date: July 2026</p>

        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-text-primary">1. Showcase Limitations</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-text-primary">2. Medical Disclaimer</h2>
          <p className="text-sm text-text-secondary">
